...
const openForm = (e) => {
    ...
    for (i = current_form == "state" ? 1 : 0; i < fields.length; i++) {
        var div = document.createElement("div")
        div.className = `input_div ${current_form}_input`
        var label_1 = document.createElement("label")
        label_1.innerHTML = fields[i]
        label_1.style.margin = "5px 0 5px 0"
        var input = document.createElement("input")
        input.id = fields[i] + "_id"
        input.type = "text"
...
const editItem = (e) => {
    ...
    if (category == "state"){
        var div = document.createElement("div")
        div.className = `input_div ${category}_input`
        var lab_1 = document.createElement("label")
        lab_1.innerHTML = fields[0];
        var input = document.createElement("select")
        input.id = fields[0] + "_id"
